...
class QuaternionFilter {
    // for madgwick
    float GyroMeasError = (double)(3.1415926535) * (40.0f / 180.0f);     // gyroscope measurement error in rads/s (start at 40 deg/s)
    float GyroMeasDrift = (double)(3.1415926535) * (0.0f / 180.0f);      // gyroscope measurement drift in rad/s/s (start at 0.0 deg/s/s)
